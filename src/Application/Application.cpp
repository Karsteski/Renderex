...
GLFWwindow* Application::Initialize() {
    // GLFW Setup
    if (!glfwInit()) {
    ...
    GLFWwindow* window = glfwCreateWindow(initialWindowWidth, initialWindowHeight, "Renderex", nullptr, nullptr);
    if (!window) {
...
int Application::Exit(GLFWwindow* window) {
    // Cleanup
